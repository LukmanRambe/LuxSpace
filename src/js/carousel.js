...
function carouselCalculateOffset() {
	const carouselOffsetLeft = carouselContainer.getBoundingClientRect().left

	carouselItems.style.paddingLeft = `${carouselOffsetLeft - 16}px`
	carouselItems.style.paddingRight = `${carouselOffsetLeft - 16}px`
}
